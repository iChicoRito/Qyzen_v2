{{-- F1: admin dashboard. Metronic card markup from public/metronic/dist/dashboards/school.html. --}}
...
@php
    $cards = [
        ['label' => 'Total Users',    'value' => $stats['users_total'],   'icon' => 'ki-profile-user'],
        ['label' => 'Active Users',   'value' => $stats['users_active'],  'icon' => 'ki-check-circle'],
        ['label' => 'Educators',      'value' => $stats['educators'],     'icon' => 'ki-teacher'],
        ['label' => 'Students',       'value' => $stats['students'],      'icon' => 'ki-people'],
        ['label' => 'Assessments',    'value' => $stats['assessments'],   'icon' => 'ki-questionnaire-tablet'],
        ['label' => 'Active Assessments', 'value' => $stats['assessments_active'], 'icon' => 'ki-abstract-26'],
    ];
@endphp
...
@section('content')
    ...
    <div class="card card-flush">
        <div class="card-header">
            <h3 class="card-title fw-bold">Top Students</h3>
        </div>

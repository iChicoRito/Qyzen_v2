...
@section('content')
    ...
    <div class="kt-card"><div class="kt-card-content flex flex-col gap-5">
        ...
        <form method="POST" action="{{ route('educator.chats.messages.send', $chat) }}" class="flex flex-wrap items-center gap-2">@csrf
        ...
        <a href="{{ route('educator.chats.index') }}" class="kt-btn kt-btn-light self-start">Back</a>
    </div></div>
@endsection

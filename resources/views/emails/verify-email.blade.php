...
<head>
  ...
  <title>Verify Your Qyzen Email</title>
</head>
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;border-collapse:collapse;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                ...
                <tr>
                  <td style="padding:40px 40px 0;">
                    <div style="font-family:ui-monospace,'Cascadia Code',Menlo,Consolas,monospace;font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:#8a8a94;">Email verification</div>
                    <h1 style="margin:16px 0 0;font-size:26px;line-height:1.25;font-weight:600;letter-spacing:-.02em;color:#18181b;">Verify your email address.</h1>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:18px 40px 0;">
                    <p style="margin:0;font-size:15px;line-height:1.65;color:#52525b;">
                      Good day, {{ $user->given_name }} {{ $user->surname }}. Confirm this email address to finish securing your Qyzen account.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:28px 40px 0;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border:1px solid #e4e4e7;border-radius:12px;">
                      ...
                      <tr>
                        <td style="padding:0 22px 20px;font-size:16px;font-weight:600;color:#18181b;word-break:break-word;">{{ $user->email }}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:28px 40px 0;">
                    <a href="{{ $verifyUrl }}" style="display:inline-block;background:#18181b;color:#ffffff;text-decoration:none;padding:13px 28px;border-radius:9999px;font-size:14px;font-weight:600;">
                ...
                <tr>
                  <td style="padding:24px 40px 40px;">
                    ...
                    <a href="{{ $verifyUrl }}" style="font-size:13px;line-height:1.6;color:#4f7bff;text-decoration:none;word-break:break-all;">{{ $verifyUrl }}</a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:20px 4px 0;font-size:12px;line-height:1.5;color:#a1a1aa;">
              {{ date('Y') }} &copy; Qyzen &middot; This notice was sent to {{ $user->email }}.
            </td>
          </tr>

{{-- Verbatim demo1 header search modal (#search_modal), index.html:6792-7672. Triggered by the topbar search icon. Demo content kept as-is per spec. --}}
         ...
         <div class="kt-menu kt-menu-default px-0.5 flex-col">
           ...
           <div class="kt-menu-link flex items-center jistify-between gap-2">
            <div class="flex items-center grow gap-2">
             <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
              <img alt="" class="size-6 shrink-0" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/brand-logos/jira.svg') }}"/>
             </div>
          ...
          <div class="kt-menu-item">
           <div class="kt-menu-link flex items-center jistify-between gap-2">
            <div class="flex items-center grow gap-2">
             <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
              <img alt="" class="size-6 shrink-0" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/brand-logos/inferno.svg') }}"/>
             </div>
             <div class="flex flex-col gap-0.5">
              <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
               Inferno
            ...
            <div class="flex justify-end shrink-0">
             <div class="flex -space-x-2">
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-14.png') }}"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-12.png') }}"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-9.png') }}"/>
              </div>
             </div>
            </div>
           </div>
         ...
         <div class="kt-menu kt-menu-default px-0.5 flex-col">
          <div class="grid gap-1">
           <div class="kt-menu-item">
            <div class="kt-menu-link flex justify-between gap-2">
             <div class="flex items-center gap-2.5">
              <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-3.png') }}"/>
           ...
           <div class="kt-menu-item">
            <div class="kt-menu-link flex justify-between gap-2">
             <div class="flex items-center gap-2.5">
              <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-1.png') }}"/>
              <div class="flex flex-col">
               <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
                Esther Howard
               </a>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/brand-logos/evernote.svg') }}"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Evernote
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-6.png') }}"/>
            </div>
            <div class="flex">
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-8.png') }}"/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/brand-logos/gitlab.svg') }}"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Gitlab
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-18.png') }}"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-17.png') }}"/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/brand-logos/google-webdev.svg') }}"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Google webdev
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-20.png') }}"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-21.png') }}"/>
            </div>
           </div>
          </div>
         </div>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        <div class="grid gap-1">
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-11.png') }}"/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              Jacob Jones
             </a>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-5.png') }}"/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              TLeslie Alexander
             </a>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/avatars/300-2.png') }}"/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              Cody Fisher
             </a>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        <div class="grid">
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/file-types/pdf.svg') }}"/>
            <div class="flex flex-col">
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/file-types/doc.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              Report-v1.docx
             </span>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/file-types/javascript.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              Framework-App.js
             </span>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/file-types/ai.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              Framework-App.js
             </span>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/file-types/php.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              appController.js
             </span>
      ...
      <div class="hidden" id="search_modal_empty">
       <div class="flex flex-col text-center py-9 gap-5">
        <div class="flex justify-center">
         <img alt="image" class="dark:hidden max-h-[113px]" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/illustrations/33.svg') }}"/>
         <img alt="image" class="light:hidden max-h-[113px]" src="{{ asset('metronic-tailwind-html-demos/dist/assets/media/illustrations/33-dark.svg') }}"/>
        </div>
